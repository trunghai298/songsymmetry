          ...
          <ul className="pt-4 text-base text-white flex flex-col sm:flex-row m-0 justify-between items-center space-y-2 sm:space-y-0 sm:space-x-4 md:pt-0">
            ...
            {isAuthenticated ? (
              ...
              <Button
                ...
                className="bg-spotify-green hover:bg-spotify-green/90 text-white font-semibold px-4 py-2 rounded-full transition-colors"
              >
                <i className="bi bi-spotify text-lg mr-2"></i>
                Sign in
              </Button>
            )}
          </ul>
